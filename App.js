...
function App() {
  ...
  return (
    React.createElement(SafeAreaView, { style: backgroundStyle },
      ...
      React.createElement(ScrollView, {
        ...
        React.createElement(View, {
          ...
          React.createElement(Section, { title: "Step One" },
            "Edit ", React.createElement(Text, { style: styles.highlight }, "App.tsx"), " to change this screen and then come back to see your edits."
          ),
